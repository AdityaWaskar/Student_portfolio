...
# -------------------------search box
        ...
        gr_no=Label(self.root, text="Search by GR no.", justify=CENTER,font=("times new roman",15),bg="white").place(x=300,y=100)
        self.gr_no=Entry(self.root,textvariable=self.var_search,justify=CENTER,font=("times new roman",15),bg="lightyellow")
        self.gr_no.place(x=480,y=100,width=150)
...
# -------------------------methods
    ...
    def search_by_gr(self):
        ...
        if(self.get_gr_no == ''):
            ...
            query = f"select sem from students where gr_no = {self.get_gr_no} ;"
            print(query)
            ...
            if(self.get_sem):
                ...
                messagebox.showinfo('message', 'gr_no not found!',parent=self.root)    
