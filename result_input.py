...
class enter_marks:
    def __init__(self,root):
        ...
        self.tt1_lbl_sub1 = Entry(m1_Frame, text="Sub 1", cursor="hand2",font=("goudy lod style",11,"bold"), justify=CENTER,bg="#0b5377", fg="white")
        self.tt1_lbl_sub1.place(x=40, y=30, width=100, height=30)
        self.tt1_mark_sub1 = Entry(m1_Frame,font=("goudy lod style",11,"bold"), justify=CENTER,bg="lightgray", fg="black")
        self.tt1_mark_sub1.place(x=150, y=30, width=100, height=30)
        self.slash = Label(m1_Frame, text=" / ", cursor="hand2",font=("goudy lod style",11,"bold"), justify=CENTER,bg="white", fg="black")
        self.slash.place(x=260, y=30, width=10, height=30)
        self.tt1_out_sub1 = Entry(m1_Frame,font=("goudy lod style",11,"bold"), justify=CENTER,bg="lightgray", fg="black")
        self.tt1_out_sub1.place(x=280, y=30, width=100, height=30)

        self.tt1_lbl_sub2 = Entry(m1_Frame, text="Sub 2", cursor="hand2",font=("goudy lod style",11,"bold"), justify=CENTER,bg="#0b5377", fg="white")
        self.tt1_lbl_sub2.place(x=40, y=70, width=100, height=30)
        self.tt1_mark_sub2 = Entry(m1_Frame,font=("goudy lod style",11,"bold"), justify=CENTER,bg="lightgray", fg="black")
        self.tt1_mark_sub2.place(x=150, y=70, width=100, height=30)
        self.slash = Label(m1_Frame, text=" / ", cursor="hand2",font=("goudy lod style",11,"bold"), justify=CENTER,bg="white", fg="black")
        self.slash.place(x=260, y=70, width=10, height=30)
        self.tt1_out_sub2 = Entry(m1_Frame,font=("goudy lod style",11,"bold"), justify=CENTER,bg="lightgray", fg="black")
        self.tt1_out_sub2.place(x=280, y=70, width=100, height=30)

        self.tt1_lbl_sub3 = Entry(m1_Frame, text="Sub 3", cursor="hand2",font=("goudy lod style",11,"bold"), justify=CENTER,bg="#0b5377", fg="white")
        self.tt1_lbl_sub3.place(x=40, y=110, width=100, height=30)
        self.tt1_mark_sub3 = Entry(m1_Frame,font=("goudy lod style",11,"bold"), justify=CENTER,bg="lightgray", fg="black")
        self.tt1_mark_sub3.place(x=150, y=110, width=100, height=30)
        self.slash = Label(m1_Frame, text=" / ", cursor="hand2",font=("goudy lod style",11,"bold"), justify=CENTER,bg="white", fg="black").place(x=260, y=110, width=10, height=30)
        self.tt1_out_sub3 = Entry(m1_Frame,font=("goudy lod style",11,"bold"), justify=CENTER,bg="lightgray", fg="black")
        self.tt1_out_sub3.place(x=280, y=110, width=100, height=30)
       
        self.tt1_lbl_sub4 = Entry(m1_Frame, text="Sub 4", cursor="hand2",font=("goudy lod style",11,"bold"), justify=CENTER,bg="#0b5377", fg="white")
        ...
        self.tt1_out_sub4 = Entry(m1_Frame,font=("goudy lod style",11,"bold"), justify=CENTER,bg="lightgray", fg="black")
        self.tt1_out_sub4.place(x=280, y=150, width=100, height=30)

        self.tt1_lbl_sub5 = Entry(m1_Frame, text="Sub 5", cursor="hand2",font=("goudy lod style",11,"bold"), justify=CENTER,bg="#0b5377", fg="white")
        ...
        self.tt1_out_sub5 = Entry(m1_Frame,font=("goudy lod style",11,"bold"), justify=CENTER,bg="lightgray", fg="black")
       ...
       #==============================tt2==========================
        ...
        self.tt2_lbl_sub1 = Entry(m2_Frame, text="Sub 1", cursor="hand2",font=("goudy lod style",11,"bold"), justify=CENTER,bg="#0b5377", fg="white")
        self.tt2_lbl_sub1.place(x=40, y=30, width=100, height=30)
        self.tt2_mark_sub1 = Entry(m2_Frame,font=("goudy lod style",11,"bold"), justify=CENTER,bg="lightgray", fg="black")
        ...
        self.slash.place(x=260, y=30, width=10, height=30)
        self.tt2_out_sub1 = Entry(m2_Frame,font=("goudy lod style",11,"bold"), justify=CENTER,bg="lightgray", fg="black")
        self.tt2_out_sub1.place(x=280, y=30, width=100, height=30)
        
        self.tt2_lbl_sub2 = Entry(m2_Frame, text="Sub 2", cursor="hand2",font=("goudy lod style",11,"bold"), justify=CENTER,bg="#0b5377", fg="white")
        self.tt2_lbl_sub2.place(x=40, y=70, width=100, height=30)
        self.tt2_mark_sub2 = Entry(m2_Frame,font=("goudy lod style",11,"bold"), justify=CENTER,bg="lightgray", fg="black")
        self.tt2_mark_sub2.place(x=150, y=70, width=100, height=30)
        self.slash = Label(m2_Frame, text=" / ", cursor="hand2",font=("goudy old style",11,"bold"), justify=CENTER,bg="white", fg="black")
        self.slash.place(x=260, y=70, width=10, height=30)
        self.tt2_out_sub2 = Entry(m2_Frame,font=("goudy lod style",11,"bold"), justify=CENTER,bg="lightgray", fg="black")
        self.tt2_out_sub2.place(x=280, y=70, width=100, height=30)
        
        
        self.tt2_lbl_sub3  = Entry(m2_Frame, text="Sub 3", cursor="hand2",font=("goudy lod style",11,"bold"), justify=CENTER,bg="#0b5377", fg="white")
        self.tt2_lbl_sub3.place(x=40, y=110, width=100, height=30)
        self.tt2_mark_sub3  = Entry(m2_Frame,font=("goudy lod style",11,"bold"), justify=CENTER,bg="lightgray", fg="black")
        self.tt2_mark_sub3.place(x=150, y=110, width=100, height=30)
        self.slash  = Entry(m2_Frame, text=" / ", cursor="hand2",font=("goudy old style",11,"bold"), justify=CENTER,bg="white", fg="black")
        self.slash.place(x=260, y=110, width=10, height=30)
        self.tt2_out_sub3  = Entry(m2_Frame,font=("goudy lod style",11,"bold"), justify=CENTER,bg="lightgray", fg="black")
        self.tt2_out_sub3.place(x=280, y=110, width=100, height=30)
        
        
        self.tt2_lbl_sub4 = Entry(m2_Frame, text="Sub 4", cursor="hand2",font=("goudy lod style",11,"bold"), justify=CENTER,bg="#0b5377", fg="white")
        self.tt2_lbl_sub4.place(x=40, y=150, width=100, height=30)
        self.tt2_mark_sub4 = Entry(m2_Frame,font=("goudy lod style",11,"bold"), justify=CENTER,bg="lightgray", fg="black")
        self.tt2_mark_sub4 .place(x=150, y=150, width=100, height=30)
        self.slash = Label(m2_Frame, text=" / ", cursor="hand2",font=("goudy old style",11,"bold"), justify=CENTER,bg="white", fg="black")
        self.slash.place(x=260, y=150, width=10, height=30)
        self.tt2_out_sub4 = Entry(m2_Frame,font=("goudy lod style",11,"bold"), justify=CENTER,bg="lightgray", fg="black")
        self.tt2_out_sub4.place(x=280, y=150, width=100, height=30)
        
        self.tt2_lbl_sub5= Entry(m2_Frame, text="Sub 5", cursor="hand2",font=("goudy lod style",11,"bold"), justify=CENTER,bg="#0b5377", fg="white")
        self.tt2_lbl_sub5.place(x=40, y=190, width=100, height=30)
        self.tt2_mark_sub5 = Entry(m2_Frame,font=("goudy lod style",11,"bold"), justify=CENTER,bg="lightgray", fg="black")
        self.tt2_mark_sub5.place(x=150, y=190, width=100, height=30)
        self.slash = Label(m2_Frame, text=" / ", cursor="hand2",font=("goudy old style",11,"bold"), justify=CENTER,bg="white", fg="black")
        self.slash.place(x=260, y=190, width=10, height=30)
        self.tt2_out_sub5 = Entry(m2_Frame,font=("goudy lod style",11,"bold"), justify=CENTER,bg="lightgray", fg="black")
       ...
       #==================semester===============
        ...
        self.ut_lbl_sub1= Entry(m3_Frame, text="Sub 1", cursor="hand2",font=("goudy lod style",11,"bold"), justify=CENTER,bg="#0b5377", fg="white")
        self.ut_lbl_sub1.place(x=40, y=30, width=100, height=30)
        self.ut_mark_sub1 = Entry(m3_Frame,font=("goudy lod style",11,"bold"), justify=CENTER,bg="lightgray", fg="black")
        ...
        self.slash.place(x=260, y=30, width=10, height=30)
        self.ut_out_sub1 = Entry(m3_Frame,font=("goudy lod style",11,"bold"), justify=CENTER,bg="lightgray", fg="black")
        self.ut_out_sub1.place(x=280, y=30, width=100, height=30)
        
        self.ut_lbl_sub2 = Entry(m3_Frame, text="Sub 2", cursor="hand2",font=("goudy lod style",11,"bold"), justify=CENTER,bg="#0b5377", fg="white")
        self.ut_lbl_sub2.place(x=40, y=70, width=100, height=30)
        self.ut_mark_sub2 = Entry(m3_Frame,font=("goudy lod style",11,"bold"), justify=CENTER,bg="lightgray", fg="black")
        self.ut_mark_sub2.place(x=150, y=70, width=100, height=30)
        self.slash = Label(m3_Frame, text=" / ", cursor="hand2",font=("goudy old style",11,"bold"), justify=CENTER,bg="white", fg="black")
        self.slash.place(x=260, y=70, width=10, height=30)
        self.ut_out_sub2 = Entry(m3_Frame,font=("goudy lod style",11,"bold"), justify=CENTER,bg="lightgray", fg="black")
        self.ut_out_sub2.place(x=280, y=70, width=100, height=30)
        
        self.ut_lbl_sub3 = Entry(m3_Frame, text="Sub 3", cursor="hand2",font=("goudy lod style",11,"bold"), justify=CENTER,bg="#0b5377", fg="white")
        self.ut_lbl_sub3.place(x=40, y=110, width=100, height=30)
        self.ut_mark_sub3 = Entry(m3_Frame,font=("goudy lod style",11,"bold"), justify=CENTER,bg="lightgray", fg="black")
        self.ut_mark_sub3.place(x=150, y=110, width=100, height=30)
        self.slash = Label(m3_Frame, text=" / ", cursor="hand2",font=("goudy old style",11,"bold"), justify=CENTER,bg="white", fg="black")
        self.slash.place(x=260, y=110, width=10, height=30)
        self.ut_out_sub3 = Entry(m3_Frame,font=("goudy lod style",11,"bold"), justify=CENTER,bg="lightgray", fg="black")
        self.ut_out_sub3.place(x=280, y=110, width=100, height=30)
        
        self.ut_lbl_sub4 = Entry(m3_Frame, text="Sub 4", cursor="hand2",font=("goudy lod style",11,"bold"), justify=CENTER,bg="#0b5377", fg="white")
        self.ut_lbl_sub4.place(x=40, y=150, width=100, height=30)
        self.ut_mark_sub4 = Entry(m3_Frame,font=("goudy lod style",11,"bold"), justify=CENTER,bg="lightgray", fg="black")
        self.ut_mark_sub4.place(x=150, y=150, width=100, height=30)
        self.slash = Label(m3_Frame, text=" / ", cursor="hand2",font=("goudy old style",11,"bold"), justify=CENTER,bg="white", fg="black")
        self.slash.place(x=260, y=150, width=10, height=30)
        self.ut_out_sub4 = Entry(m3_Frame,font=("goudy lod style",11,"bold"), justify=CENTER,bg="lightgray", fg="black")
        self.ut_out_sub4.place(x=280, y=150, width=100, height=30)
        
        self.ut_lbl_sub5 = Entry(m3_Frame, text="Sub 5", cursor="hand2",font=("goudy lod style",11,"bold"), justify=CENTER,bg="#0b5377", fg="white")
        self.ut_lbl_sub5.place(x=40, y=190, width=100, height=30)
        self.ut_mark_sub5 = Entry(m3_Frame,font=("goudy lod style",11,"bold"), justify=CENTER,bg="lightgray", fg="black")
        self.ut_mark_sub5.place(x=150, y=190, width=100, height=30)
        self.slash = Label(m3_Frame, text=" / ", cursor="hand2",font=("goudy old style",11,"bold"), justify=CENTER,bg="white", fg="black")
        self.slash.place(x=260, y=190, width=10, height=30)
        self.ut_out_sub5 = Entry(m3_Frame,font=("goudy lod style",11,"bold"), justify=CENTER,bg="lightgray", fg="black")
...
# ---------------setting the tt1 subjects
        ...
        self.tt1_lbl_sub1.config(state='readonly', fg='64b9cc')
        self.tt1_lbl_sub2.config(state='readonly', fg='0b5377')
        self.tt1_lbl_sub3.config(state='readonly', fg='0b5377')
        self.tt1_lbl_sub4.config(state='readonly', fg='0b5377')
        self.tt1_lbl_sub5.config(state='readonly', fg='0b5377')
...
# ---------------setting the tt2 subjects
        ...
        self.tt2_lbl_sub1.config(state='readonly', fg='64b9cc')
        self.tt2_lbl_sub2.config(state='readonly', fg='0b5377')
        self.tt2_lbl_sub3.config(state='readonly', fg='0b5377')
        self.tt2_lbl_sub4.config(state='readonly', fg='0b5377')
        self.tt2_lbl_sub5.config(state='readonly', fg='0b5377')
...
# ---------------setting the ut subjects
        ...
        # self.ut_lbl_sub1.config(state='readonly', fg='64b9cc')
        # self.ut_lbl_sub2.config(state='readonly', fg='0b5377')
        # self.ut_lbl_sub3.config(state='readonly', fg='0b5377')
        # self.ut_lbl_sub4.config(state='readonly', fg='0b5377')
        # self.ut_lbl_sub5.config(state='readonly', fg='0b5377')
