...
class extracurricular:
    def __init__(self,root):
        ...
        self.gr_no.place(x=100,y=10,width=120)

        dob=Label(self.first_Frame,text="DOB.",font=("times new roman",15,"bold"),bg="white").place(x=240,y=10)
        # self.dob=Entry(self.first_Frame,font=("times new roman",15),bg="lightyellow")
        self.dob = DateEntry(self.first_Frame, selectmode="day",date_pattern = 'dd/mm/yyyy',background="blue",Cursor="hand1",year=2003, month=1, foreground='black', font=("Arial", 12))
        self.dob.place(x=300,y=10,width=120)
